    ...
    },
{
  ...
  steps: [
    ...
    "Entrega de Badge Digital: Reconhecimento da conclusão do Onboarding A360 na Feedz.",
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg text-gray-700 text-justify leading-relaxed">
            A DBAOnline está em expansão, mas seu onboarding é fragmentado, reativo e sem padrão. Novos talentos e líderes promovidos não são plenamente integrados à cultura, processos ou expectativas da empresa.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
              <h4 className="font-semibold text-red-800 mb-2">Problemas Identificados</h4>
              <ul className="text-red-700 space-y-1 text-sm">
                <li>🔗 Ausência de um modelo padronizado de onboarding entre áreas.</li>
                <li>⚙️ Processos internos desatualizados e pouco conectados à cultura da empresa.</li>
                <li>💬 Comunicação fragmentada entre equipes e lideranças.</li>
                <li>🧑‍💼 Líderes pouco preparados para atuar como multiplicadores da cultura organizacional.</li>
				<li>📌 Dificuldade em engajar e reter novos colaboradores.</li>
				<li>🌟 Baixa atratividade da empresa para talentos em busca de crescimento ou transição de carreira.</li>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
              ...
              <ul className="text-blue-700 space-y-1 text-sm">
                <li>🚪 Sensação de isolamento e falta de pertencimento nos primeiros meses de jornada.</li>
                <li>🤝 Barreiras à colaboração interdepartamental, comprometendo eficiência e inovação.</li>
                <li>🔄️ Alta rotatividade de talentos, especialmente em cargos estratégicos e de liderança.</li>
                <li>🏛 Cultura organizacional enfraquecida, dificultando a consolidação de valores e práticas comuns.</li>
				<li>📉 Perda de produtividade e aumento de retrabalho por falta de alinhamento inicial.</li>
              </ul>
            </div>
          </div>
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg">
            <p className="text-center font-medium">
              "Um onboarding bem estruturado transforma talentos em protagonistas da cultura."
            </p>
          </div>
        </div>
      )
...
{
  title: "🚀 A Solução: Onboarding A360",
  content: (
    <div className="space-y-6">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg">
          ...
          <p className="text-gray-600">5 dias úteis ou 30 dias para a Liderança</p>
        </div>
...
,
    {
      title: "🎯 As 6 Missões do Onboarding A360",
      content: (
        <div className="space-y-6">
      ...
      content: (
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">
              Com a expansão da empresa, o Onboarding A360 será a chave para <span className="font-bold text-black-600">escalar com consistência</span>.
            </p>
          </div>
         ...
         <div className="bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-800 p-8 rounded-lg">
            ...
            <blockquote className="text-lg italic text-center leading-relaxed">
              "Após 25 anos de trajetória, chegou o momento de assegurar que cada pessoa que se junta a nós compreenda a base sólida que construímos e a visão de futuro que seguimos. O Onboarding A360 conecta nosso legado à nossa ambição de crescimento, promovendo integração genuína, clareza de propósito e atitude desde o primeiro dia."
            </blockquote>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 rounded-lg p-6 text-white">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-semibold">Vídeo de Boas-Vindas Onboarding A360</h4>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">🎯 As 6 Missões do Onboarding A360</h2>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg p-8 text-center">
                <div className="mb-6">
                  ...
                  <h2 className="text-3xl font-bold text-gray-800 mb-4">🎯 Jogo de Cenários Onboarding A360</h2>
                  <p className="text-lg text-gray-600">
