...
const App: React.FC = () => {
  ...
  const slides = [
      ...
      content: (
        <div className="space-y-6">
          <p className="text-lg text-gray-700 leading-relaxed">
            Apesar da nossa sólida trajetória de <span className="font-bold text-blue-600">25 anos no mercado</span>, temos enfrentado problemas recorrentes que evidenciam a falta de um processo estruturado de onboarding. Esses problemas não apenas afetam a eficiência operacional, mas também impactam a experiência do cliente e o desenvolvimento de nossos colaboradores.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
              ...
              <ul className="text-blue-700 space-y-1 text-sm">
                <li>• 78 colaboradores atualmente</li>
    ...
    {
      title: "🎯 As 5 Missões da Imersão A360",
      content: (
        <div className="space-y-6">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">🎯 As 5 Missões da Imersão A360</h2>
...
<div className="relative bg-gradient-to-l from-blue-700 via-cyan-500 to-teal-300
                text-gray-900 rounded-lg shadow-lg px-6 py-4 flex flex-col md:flex-row items-center md:items-start">

  {/* Texto centralizado, ocupa espaço disponível */}
  <div className="flex-1 flex items-center justify-center text-center md:text-left mb-4 md:mb-0">
    <h1 className="text-xl md:text-2xl break-words">
      Academia de Líderes 2025 – Equipe: Andressa Mirian · Gabriela Anselmo · Nary Dorta
    </h1>
  </div>

  {/* Logo à direita, proporcional */}
  <img
    src={icongurias}
    alt="icongurias"
    className="w-auto max-h-16 md:max-h-20 object-contain pointer-events-none select-none"
  />
</div>
